...
@Component({
    ...
    template: `
    <div class="fixed bottom-6 right-6 z-[9999] flex flex-col gap-3 w-80 max-w-[90vw]">
      @for (n of notificationService.notifications(); track n.id) {
        <div
          class="flex items-start gap-3 p-4 rounded-2xl border shadow-xl animate-slide-in-right backdrop-blur-md"
